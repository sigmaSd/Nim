...
var NTI486539793 = {size: 0, kind: 24, base: null, node: null, finalizer: null};
...
function setTheme(theme_486539268) {
    document.documentElement.setAttribute("data-theme", theme_486539268);
    window.localStorage.setItem("theme", theme_486539268);

  
}
var Temporary1;
var t_486539287 = window.localStorage.getItem("theme");
if ((t_486539287 == null)) {
Temporary1 = "auto";
}
else {
Temporary1 = t_486539287;
}
...
function addChars_251658415(result_251658417, result_251658417_Idx, x_251658418, start_251658419, n_251658420) {
    ...
    Label1: {
      ...
      Label2: {
          Label3: while (true) {
          if (!(i_486539360 < n_251658420)) break Label3;
            iHEX60gensym4_251658435 = i_486539360;
            result_251658417[result_251658417_Idx][chckIndx(addInt(old_251658421, iHEX60gensym4_251658435), 0, (result_251658417[result_251658417_Idx]).length - 1)] = x_251658418.charCodeAt(chckIndx(addInt(start_251658419, iHEX60gensym4_251658435), 0, (x_251658418).length - 1));
            i_486539360 = addInt(i_486539360, 1);
          }
      };
    };
...
function onDOMLoaded(e_486539289) {
            
function HEX3Aanonymous_486539312(event_486539313) {
                event_486539313.target.parentNode.style.display = "none";
                event_486539313.target.parentNode.nextSibling.style.display = "inline";
    ...
    Label1: {
      var pragmaDots_486539311 = null;
      var colontmp__486539351 = [];
      colontmp__486539351 = document.getElementsByClassName("pragmadots");
      var i_486539353 = 0;
      var L_486539354 = (colontmp__486539351).length;
      Label2: {
          Label3: while (true) {
          if (!(i_486539353 < L_486539354)) break Label3;
            pragmaDots_486539311 = colontmp__486539351[chckIndx(i_486539353, 0, (colontmp__486539351).length - 1)];
            pragmaDots_486539311.onclick = HEX3Aanonymous_486539312;
            i_486539353 = addInt(i_486539353, 1);
            if (!(((colontmp__486539351).length == L_486539354))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
...
var alternative_486539846 = [null];

function isWhitespace_486539594(x_486539595) {
    var Temporary1;
    var Temporary2;

  var result_486539596 = false;

    if (!(x_486539595.nodeName == "#text")) Temporary2 = false; else {      Temporary2 = !/\S/.test(x_486539595.textContent);    }    if (Temporary2) Temporary1 = true; else {      Temporary1 = (x_486539595.nodeName == "#comment");    }    result_486539596 = Temporary1;

  return result_486539596;

}

function toToc_486539597(x_486539598, father_486539599) {
                var Temporary5;
            var Temporary6;
            var Temporary7;
            var Temporary8;
    ...
    if ((x_486539598.nodeName == "UL")) {
    var f_486539607 = {heading: null, kids: [], sortId: (father_486539599.kids).length, doSort: false};
    var i_486539608 = 0;
    Label1: {
        Label2: while (true) {
        if (!(i_486539608 < x_486539598.childNodes.length)) break Label2;
          var nxt_486539609 = addInt(i_486539608, 1);
          Label3: {
              Label4: while (true) {
                if (!(nxt_486539609 < x_486539598.childNodes.length)) Temporary5 = false; else {                  Temporary5 = isWhitespace_486539594(x_486539598.childNodes[nxt_486539609]);                }              if (!Temporary5) break Label4;
                nxt_486539609 = addInt(nxt_486539609, 1);
              }
          };
            if (!(nxt_486539609 < x_486539598.childNodes.length)) Temporary8 = false; else {              Temporary8 = (x_486539598.childNodes[i_486539608].nodeName == "LI");            }            if (!Temporary8) Temporary7 = false; else {              Temporary7 = (x_486539598.childNodes[i_486539608].childNodes.length == 1);            }            if (!Temporary7) Temporary6 = false; else {              Temporary6 = (x_486539598.childNodes[nxt_486539609].nodeName == "UL");            }          if (Temporary6) {
          var e_486539621 = {heading: x_486539598.childNodes[i_486539608].childNodes[0], kids: [], sortId: (f_486539607.kids).length, doSort: false};
          var it_486539622 = x_486539598.childNodes[nxt_486539609];
          Label9: {
            var j_486539627 = 0;
            var colontmp__486539884 = 0;
            colontmp__486539884 = it_486539622.childNodes.length;
            var i_486539885 = 0;
            Label10: {
                Label11: while (true) {
                if (!(i_486539885 < colontmp__486539884)) break Label11;
                  j_486539627 = i_486539885;
                  toToc_486539597(it_486539622.childNodes[j_486539627], e_486539621);
                  i_486539885 = addInt(i_486539885, 1);
                }
            };
          };
          f_486539607.kids.push(e_486539621);;
          i_486539608 = addInt(nxt_486539609, 1);
          }
          else {
            toToc_486539597(x_486539598.childNodes[i_486539608], f_486539607);
            i_486539608 = addInt(i_486539608, 1);
          }
          
        }
    };
    father_486539599.kids.push(f_486539607);;
    }
    else {
    if (isWhitespace_486539594(x_486539598)) {
    }
    else {
    if ((x_486539598.nodeName == "LI")) {
    var idx_486539644 = [];
    Label12: {
      var i_486539649 = 0;
      var colontmp__486539888 = 0;
      colontmp__486539888 = x_486539598.childNodes.length;
      var i_486539889 = 0;
      Label13: {
          Label14: while (true) {
          if (!(i_486539889 < colontmp__486539888)) break Label14;
            i_486539649 = i_486539889;
            if (!(isWhitespace_486539594(x_486539598.childNodes[i_486539649]))) {
            idx_486539644.push(i_486539649);;
            }
      ...
      if (!((idx_486539644).length == 2)) Temporary15 = false; else {        Temporary15 = (x_486539598.childNodes[idx_486539644[chckIndx(1, 0, (idx_486539644).length - 1)]].nodeName == "UL");      }    if (Temporary15) {
    var e_486539665 = {heading: x_486539598.childNodes[idx_486539644[chckIndx(0, 0, (idx_486539644).length - 1)]], kids: [], sortId: (father_486539599.kids).length, doSort: false};
    var it_486539666 = x_486539598.childNodes[idx_486539644[chckIndx(1, 0, (idx_486539644).length - 1)]];
    Label16: {
      var j_486539671 = 0;
      var colontmp__486539892 = 0;
      colontmp__486539892 = it_486539666.childNodes.length;
      var i_486539893 = 0;
      Label17: {
          Label18: while (true) {
          if (!(i_486539893 < colontmp__486539892)) break Label18;
            j_486539671 = i_486539893;
            toToc_486539597(it_486539666.childNodes[j_486539671], e_486539665);
            i_486539893 = addInt(i_486539893, 1);
          }
      };
    };
    father_486539599.kids.push(e_486539665);;
    }
    else {
      Label19: {
        var i_486539680 = 0;
        var colontmp__486539896 = 0;
        colontmp__486539896 = x_486539598.childNodes.length;
        var i_486539897 = 0;
        Label20: {
            Label21: while (true) {
            if (!(i_486539897 < colontmp__486539896)) break Label21;
              i_486539680 = i_486539897;
              toToc_486539597(x_486539598.childNodes[i_486539680], father_486539599);
    ...
    father_486539599.kids.push({heading: x_486539598, kids: [], sortId: (father_486539599.kids).length, doSort: false});;
    }
    }}
...
function extractItems_486539432(x_486539433, heading_486539434, items_486539435, items_486539435_Idx) {
      var Temporary1;
  ...
  BeforeRet: {
    ...
    break BeforeRet;
      ...
      if (!!((x_486539433.heading == null))) Temporary1 = false; else {        Temporary1 = (x_486539433.heading.textContent == heading_486539434);      }    if (Temporary1) {
    Label2: {
      var i_486539452 = 0;
      var colontmp__486539900 = 0;
      colontmp__486539900 = (x_486539433.kids).length;
      var i_486539901 = 0;
      Label3: {
          Label4: while (true) {
          if (!(i_486539901 < colontmp__486539900)) break Label4;
            i_486539452 = i_486539901;
            items_486539435[items_486539435_Idx].push(x_486539433.kids[chckIndx(i_486539452, 0, (x_486539433.kids).length - 1)].heading);;
      ...
      Label5: {
        var k_486539477 = null;
        var i_486539905 = 0;
        var L_486539906 = (x_486539433.kids).length;
        Label6: {
            Label7: while (true) {
            if (!(i_486539905 < L_486539906)) break Label7;
              k_486539477 = x_486539433.kids[chckIndx(i_486539905, 0, (x_486539433.kids).length - 1)];
              extractItems_486539432(k_486539477, heading_486539434, items_486539435, items_486539435_Idx);
              i_486539905 = addInt(i_486539905, 1);
              if (!(((x_486539433.kids).length == L_486539906))) {
              failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
              }
...
function tree_486539364(tag_486539365, kids_486539366) {
  var result_486539367 = null;

    result_486539367 = document.createElement(tag_486539365);
    Label1: {
      var k_486539380 = null;
      var i_486539918 = 0;
      Label2: {
          Label3: while (true) {
          if (!(i_486539918 < (kids_486539366).length)) break Label3;
            k_486539380 = kids_486539366[chckIndx(i_486539918, 0, (kids_486539366).length - 1)];
            result_486539367.appendChild(k_486539380);
            i_486539918 = addInt(i_486539918, 1);
          }
      };
    };
...
function text_486539388(s_486539389) {
  var result_486539390 = null;

    result_486539390 = document.createTextNode(s_486539389);

  return result_486539390;

}

function uncovered_486539746(x_486539747) {
      var Temporary1;
    var Temporary2;
  ...
  BeforeRet: {
      if (!((x_486539747.kids).length == 0)) Temporary1 = false; else {        Temporary1 = !((x_486539747.heading == null));      }    if (Temporary1) {
    if (!(x_486539747.heading.hasOwnProperty('__karaxMarker__'))) {
    Temporary2 = x_486539747;
    }
    else {
    Temporary2 = null;
    }
    
    result_486539748 = Temporary2;
    break BeforeRet;
    }
    
    result_486539748 = {heading: x_486539747.heading, kids: [], sortId: x_486539747.sortId, doSort: x_486539747.doSort};
    Label3: {
      var k_486539763 = null;
      var i_486539925 = 0;
      var L_486539926 = (x_486539747.kids).length;
      Label4: {
          Label5: while (true) {
          if (!(i_486539925 < L_486539926)) break Label5;
            k_486539763 = x_486539747.kids[chckIndx(i_486539925, 0, (x_486539747.kids).length - 1)];
            var y_486539764 = uncovered_486539746(k_486539763);
            if (!((y_486539764 == null))) {
            result_486539748.kids.push(y_486539764);;
            }
            
            i_486539925 = addInt(i_486539925, 1);
            if (!(((x_486539747.kids).length == L_486539926))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    if (((result_486539748.kids).length == 0)) {
    result_486539748 = null;
    }
...
function mergeTocs_486539776(orig_486539777, news_486539778) {
  var result_486539779 = null;

    result_486539779 = uncovered_486539746(orig_486539777);
    if ((result_486539779 == null)) {
    result_486539779 = news_486539778;
    }
    else {
      Label1: {
        var i_486539791 = 0;
        var colontmp__486539921 = 0;
        colontmp__486539921 = (news_486539778.kids).length;
        var i_486539922 = 0;
        Label2: {
            Label3: while (true) {
            if (!(i_486539922 < colontmp__486539921)) break Label3;
              i_486539791 = i_486539922;
              result_486539779.kids.push(news_486539778.kids[chckIndx(i_486539791, 0, (news_486539778.kids).length - 1)]);;
              i_486539922 = addInt(i_486539922, 1);
            }
        };
      };
    }
  ...
  return result_486539779;

}

function buildToc_486539796(orig_486539797, types_486539798, procs_486539799) {
                      var Temporary7;

  var result_486539800 = null;

    var newStuff_486539805 = {heading: null, kids: [], doSort: true, sortId: 0};
    Label1: {
      var t_486539809 = null;
      var i_486539913 = 0;
      var L_486539914 = (types_486539798).length;
      Label2: {
          Label3: while (true) {
          if (!(i_486539913 < L_486539914)) break Label3;
            t_486539809 = types_486539798[chckIndx(i_486539913, 0, (types_486539798).length - 1)];
            var c_486539814 = {heading: t_486539809.cloneNode(true), kids: [], doSort: true, sortId: 0};
            t_486539809.__karaxMarker__ = true;
            Label4: {
              var p_486539818 = null;
              var i_486539910 = 0;
              var L_486539911 = (procs_486539799).length;
              Label5: {
                  Label6: while (true) {
                  if (!(i_486539910 < L_486539911)) break Label6;
                    p_486539818 = procs_486539799[chckIndx(i_486539910, 0, (procs_486539799).length - 1)];
                    if (!(p_486539818.hasOwnProperty('__karaxMarker__'))) {
                    var xx_486539819 = p_486539818.parentNode.getElementsByClassName("attachedType");
                      if (!((xx_486539819).length == 1)) Temporary7 = false; else {                        Temporary7 = (xx_486539819[chckIndx(0, 0, (xx_486539819).length - 1)].textContent == t_486539809.textContent);                      }                    if (Temporary7) {
                    var q_486539824 = tree_486539364("A", [text_486539388(p_486539818.title)]);
                    q_486539824.setAttribute("href", p_486539818.getAttribute("href"));
                    c_486539814.kids.push({heading: q_486539824, kids: [], sortId: 0, doSort: false});;
                    p_486539818.__karaxMarker__ = true;
                    }
                    
                    }
                    
                    i_486539910 = addInt(i_486539910, 1);
                    if (!(((procs_486539799).length == L_486539911))) {
                    failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
                    }
            ...
            newStuff_486539805.kids.push(c_486539814);;
            i_486539913 = addInt(i_486539913, 1);
            if (!(((types_486539798).length == L_486539914))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    result_486539800 = mergeTocs_486539776(orig_486539797, newStuff_486539805);

  return result_486539800;

}

function add_486539381(parent_486539382, kid_486539383) {
      var Temporary1;
        var Temporary2;

      if (!(parent_486539382.nodeName == "TR")) Temporary1 = false; else {        if ((kid_486539383.nodeName == "TD")) Temporary2 = true; else {          Temporary2 = (kid_486539383.nodeName == "TH");        }        Temporary1 = Temporary2;      }    if (Temporary1) {
    var k_486539384 = document.createElement("TD");
    k_486539384.appendChild(kid_486539383);
    parent_486539382.appendChild(k_486539384);
    }
    else {
    parent_486539382.appendChild(kid_486539383);
    }
...
function setClass_486539385(e_486539386, value_486539387) {
    e_486539386.setAttribute("class", value_486539387);

  
}

function toHtml_486539496(x_486539497, isRoot_486539498) {
      var Temporary1;
    
function HEX3Aanonymous_486539516(a_486539517, b_486539518) {
          var Temporary1;

      var result_486539519 = 0;

      BeforeRet: {
          if (!!((a_486539517.heading == null))) Temporary1 = false; else {            Temporary1 = !((b_486539518.heading == null));          }        if (Temporary1) {
        var x_486539528 = a_486539517.heading.textContent;
        var y_486539529 = b_486539518.heading.textContent;
        if ((x_486539528 < y_486539529)) {
        result_486539519 = -1;
        break BeforeRet;
        }
        
        if ((y_486539529 < x_486539528)) {
        result_486539519 = 1;
        break BeforeRet;
        }
        ...
        break BeforeRet;
          ...
          result_486539519 = subInt(a_486539517.sortId, b_486539518.sortId);
          break BeforeRet;
        }
        
      };

      return result_486539519;

    }

  var result_486539499 = null;

  BeforeRet: {
    if ((x_486539497 == null)) {
    result_486539499 = null;
    break BeforeRet;
    }
    
    if (((x_486539497.kids).length == 0)) {
    if ((x_486539497.heading == null)) {
    result_486539499 = null;
    break BeforeRet;
    }
    
    result_486539499 = x_486539497.heading.cloneNode(true);
    break BeforeRet;
    }
    
    result_486539499 = tree_486539364("DIV", []);
      if (!!((x_486539497.heading == null))) Temporary1 = false; else {        Temporary1 = !(x_486539497.heading.hasOwnProperty('__karaxMarker__'));      }    if (Temporary1) {
    add_486539381(result_486539499, x_486539497.heading.cloneNode(true));
    }
    
    var ul_486539515 = tree_486539364("UL", []);
    if (isRoot_486539498) {
    setClass_486539385(ul_486539515, "simple simple-toc");
    }
    else {
    setClass_486539385(ul_486539515, "simple");
    }
    
    if (x_486539497.doSort) {
    x_486539497.kids.sort(HEX3Aanonymous_486539516);
    }
    
    Label2: {
      var k_486539541 = null;
      var i_486539929 = 0;
      var L_486539930 = (x_486539497.kids).length;
      Label3: {
          Label4: while (true) {
          if (!(i_486539929 < L_486539930)) break Label4;
            k_486539541 = x_486539497.kids[chckIndx(i_486539929, 0, (x_486539497.kids).length - 1)];
            var y_486539542 = toHtml_486539496(k_486539541, false);
            if (!((y_486539542 == null))) {
            add_486539381(ul_486539515, tree_486539364("LI", [y_486539542]));
            }
            
            i_486539929 = addInt(i_486539929, 1);
            if (!(((x_486539497.kids).length == L_486539930))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    if (!((ul_486539515.childNodes.length == 0))) {
    add_486539381(result_486539499, ul_486539515);
    }
    
    if ((result_486539499.childNodes.length == 0)) {
    result_486539499 = null;
    }
    
  };

  return result_486539499;

}

function replaceById_486539391(id_486539392, newTree_486539393) {
    var x_486539394 = document.getElementById(id_486539392);
    x_486539394.parentNode.replaceChild(newTree_486539393, x_486539394);
    newTree_486539393.id = id_486539392;

  
}

function togglevis_486539847(d_486539848) {
    if ((d_486539848.style.display == "none")) {
    d_486539848.style.display = "inline";
    }
    else {
      d_486539848.style.display = "none";
    }
...
function groupBy(value_486539850) {
    var toc_486539851 = document.getElementById("toc-list");
    if ((alternative_486539846[0] == null)) {
    var tt_486539859 = {heading: null, kids: [], sortId: 0, doSort: false};
    toToc_486539597(toc_486539851, tt_486539859);
    tt_486539859 = tt_486539859.kids[chckIndx(0, 0, (tt_486539859.kids).length - 1)];
    var types_486539864 = [[]];
    var procs_486539869 = [[]];
    extractItems_486539432(tt_486539859, "Types", types_486539864, 0);
    extractItems_486539432(tt_486539859, "Procs", procs_486539869, 0);
    extractItems_486539432(tt_486539859, "Converters", procs_486539869, 0);
    extractItems_486539432(tt_486539859, "Methods", procs_486539869, 0);
    extractItems_486539432(tt_486539859, "Templates", procs_486539869, 0);
    extractItems_486539432(tt_486539859, "Macros", procs_486539869, 0);
    extractItems_486539432(tt_486539859, "Iterators", procs_486539869, 0);
    var ntoc_486539870 = buildToc_486539796(tt_486539859, types_486539864[0], procs_486539869[0]);
    var x_486539871 = toHtml_486539496(ntoc_486539870, true);
    alternative_486539846[0] = tree_486539364("DIV", [x_486539871]);
    }
    
    if ((value_486539850 == "type")) {
    replaceById_486539391("tocRoot", alternative_486539846[0]);
    }
    else {
    replaceById_486539391("tocRoot", tree_486539364("DIV", []));
    }
    
    togglevis_486539847(document.getElementById("toc-list"));

  
}
var db_486539932 = [[]];
var contents_486539933 = [[]];
var oldtoc_486540096 = [null];
var timer_486540097 = [null];

function nsuToLowerAsciiChar(c_654311508) {
  var result_654311509 = 0;

    if ((ConstSet2[c_654311508] != undefined)) {
    result_654311509 = (c_654311508 ^ 32);
    }
    else {
      result_654311509 = c_654311508;
    }
...
function fuzzyMatch_637534224(pattern_637534225, str_637534226) {
  ...
  var result_637534229 = {Field0: 0, Field1: false};
    ...
    var colontmp__486540157 = nimMax(0, score_637534236);
    var colontmp__486540158 = (0 < score_637534236);
    result_637534229 = nimCopy(result_637534229, {Field0: colontmp__486540157, Field1: colontmp__486540158}, NTI637534222);

  return result_637534229;

}

function escapeCString_486539934(x_486539935, x_486539935_Idx) {
    var s_486539936 = [];
    Label1: {
      var c_486539937 = 0;
      var iHEX60gensym6_486540161 = 0;
      var nHEX60gensym6_486540162 = ((x_486539935[x_486539935_Idx]) == null ? 0 : (x_486539935[x_486539935_Idx]).length);
      Label2: {
          Label3: while (true) {
          if (!(iHEX60gensym6_486540161 < nHEX60gensym6_486540162)) break Label3;
            c_486539937 = x_486539935[x_486539935_Idx].charCodeAt(chckIndx(iHEX60gensym6_486540161, 0, (x_486539935[x_486539935_Idx]).length - 1));
            switch (c_486539937) {
            case 60:
              s_486539936.push.apply(s_486539936, makeNimstrLit("&lt;"));;
              break;
            case 62:
              s_486539936.push.apply(s_486539936, makeNimstrLit("&gt;"));;
              break;
            default: 
              addChar(s_486539936, c_486539937);;
              break;
            }
            iHEX60gensym6_486540161 = addInt(iHEX60gensym6_486540161, 1);
          }
      };
    };
    x_486539935[x_486539935_Idx] = toJSStr(s_486539936);

  
}

function dosearch_486539938(value_486539939) {
    
function HEX3Aanonymous_486539995(a_486540000, b_486540001) {
      var result_486540006 = 0;

        result_486540006 = subInt(b_486540001["Field1"], a_486540000["Field1"]);

      return result_486540006;

    }

  var result_486539940 = null;

    if (((db_486539932[0]).length == 0)) {
    var stuff_486539944 = null;
    ...
    stuff_486539944 = doc.documentElement;
    
    db_486539932[0] = nimCopy(null, stuff_486539944.getElementsByClassName("reference"), NTI620757439);
    contents_486539933[0] = nimCopy(null, [], NTI486539793);
    Label1: {
      var ahref_486539969 = null;
      var i_486540142 = 0;
      var L_486540143 = (db_486539932[0]).length;
      Label2: {
          Label3: while (true) {
          if (!(i_486540142 < L_486540143)) break Label3;
            ahref_486539969 = db_486539932[0][chckIndx(i_486540142, 0, (db_486539932[0]).length - 1)];
            contents_486539933[0].push(ahref_486539969.getAttribute("data-doc-search-tag"));;
            i_486540142 = addInt(i_486540142, 1);
            if (!(((db_486539932[0]).length == L_486540143))) {
            failedAssertImpl_218103864(makeNimstrLit("iterators.nim(244, 11) `len(a) == L` the length of the seq changed while iterating over it"));
            }
    ...
    var ul_486539974 = tree_486539364("UL", []);
    result_486539940 = tree_486539364("DIV", []);
    setClass_486539385(result_486539940, "search_results");
    var matches_486539979 = [];
    Label4: {
      var i_486539987 = 0;
      var colontmp__486540147 = 0;
      colontmp__486540147 = (db_486539932[0]).length;
      var i_486540148 = 0;
      Label5: {
          Label6: while (true) {
          if (!(i_486540148 < colontmp__486540147)) break Label6;
            i_486539987 = i_486540148;
            Label7: {
              var c_486539988 = contents_486539933[0][chckIndx(i_486539987, 0, (contents_486539933[0]).length - 1)];
              if (((c_486539988 == "Examples") || (c_486539988 == "PEG construction"))) {
              break Label7;
              }
              
              var colontmp__486540154 = fuzzyMatch_637534224(value_486539939, c_486539988);
              var score_486539989 = colontmp__486540154["Field0"];
              var matched_486539990 = colontmp__486540154["Field1"];
              if (matched_486539990) {
              matches_486539979.push({Field0: db_486539932[0][chckIndx(i_486539987, 0, (db_486539932[0]).length - 1)], Field1: score_486539989});;
              }
    ...
    matches_486539979.sort(HEX3Aanonymous_486539995);
    Label8: {
      var i_486540023 = 0;
      var colontmp__486540151 = 0;
      colontmp__486540151 = nimMin((matches_486539979).length, 29);
      var i_486540152 = 0;
      Label9: {
          Label10: while (true) {
          if (!(i_486540152 < colontmp__486540151)) break Label10;
            i_486540023 = i_486540152;
            matches_486539979[chckIndx(i_486540023, 0, (matches_486539979).length - 1)]["Field0"].innerHTML = matches_486539979[chckIndx(i_486540023, 0, (matches_486539979).length - 1)]["Field0"].getAttribute("data-doc-search-tag");
            escapeCString_486539934(matches_486539979[chckIndx(i_486540023, 0, (matches_486539979).length - 1)]["Field0"], "innerHTML");
            add_486539381(ul_486539974, tree_486539364("LI", [matches_486539979[chckIndx(i_486540023, 0, (matches_486539979).length - 1)]["Field0"]]));
            i_486540152 = addInt(i_486540152, 1);
          }
      };
    };
    if ((ul_486539974.childNodes.length == 0)) {
    add_486539381(result_486539940, tree_486539364("B", [text_486539388("no search results")]));
    }
    else {
      add_486539381(result_486539940, tree_486539364("B", [text_486539388("search results")]));
      add_486539381(result_486539940, ul_486539974);
    }
    

  return result_486539940;

}

function search() {
    
function wrapper_486540108() {
        var elem_486540109 = document.getElementById("searchInput");
        var value_486540110 = elem_486540109.value;
        if (!((((value_486540110) == null ? 0 : (value_486540110).length) == 0))) {
        if ((oldtoc_486540096[0] == null)) {
        oldtoc_486540096[0] = document.getElementById("tocRoot");
        }
        
        var results_486540114 = dosearch_486539938(value_486540110);
        replaceById_486539391("tocRoot", results_486540114);
        }
        else {
        if (!((oldtoc_486540096[0] == null))) {
        replaceById_486539391("tocRoot", oldtoc_486540096[0]);
        }
        }
    ...
    if (!((timer_486540097[0] == null))) {
    clearTimeout(timer_486540097[0]);
    }
    
    timer_486540097[0] = setTimeout(wrapper_486540108, 400);
