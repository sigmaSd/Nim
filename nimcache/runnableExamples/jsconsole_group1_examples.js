  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_587202595 < n_251658420)) break Label3;
            F.line = 49;
            iHEX60gensym4_251658435 = i_587202595;
            F.line = 49;
...
function auxWriteStackTrace_33556554(f_33556555) {
  var result_33556556 = [[]];
    ...
    Label5: {
      var j_33556597 = 0;
      var colontmp__587202587 = 0;
      colontmp__587202587 = (i_33556565 - 1);
      var res_587202589 = colontmp__587202587;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_587202589)) break Label7;
            j_33556597 = res_587202589;
