  ...
  framePtr = F;
    ...
    Label1: {
      ...
      Label2: {
        F.line = 120;
          Label3: while (true) {
          if (!(i_587202603 < n_251658420)) break Label3;
            F.line = 49;
            iHEX60gensym4_251658435 = i_587202603;
            F.line = 49;
            result_251658417[result_251658417_Idx][chckIndx(addInt(old_251658421, iHEX60gensym4_251658435), 0, (result_251658417[result_251658417_Idx]).length - 1)] = x_251658418.charCodeAt(chckIndx(addInt(start_251658419, iHEX60gensym4_251658435), 0, (x_251658418).length - 1));
            F.line = 122;
            i_587202603 = addInt(i_587202603, 1);
          }
      };
    };
  framePtr = F.prev;
...
function auxWriteStackTrace_33556554(f_33556555) {
  var result_33556556 = [[]];
    ...
    Label5: {
      var j_33556597 = 0;
      var colontmp__587202595 = 0;
      colontmp__587202595 = (i_33556565 - 1);
      var res_587202597 = colontmp__587202595;
      Label6: {
          Label7: while (true) {
          if (!(0 <= res_587202597)) break Label7;
            j_33556597 = res_587202597;
...
framePtr = F;
F.line = 57;
var data_587202562 = new FormData();
F.line = 57;
data_587202562.set("key0", "value0");
F.line = 57;
data_587202562.append("key1", "value1");
F.line = 57;
data_587202562.delete("key1");
if (!(data_587202562.has("key0"))) {
F.line = 57;
...
if (!((data_587202562.get("key0") == "value0"))) {
F.line = 57;
...
F.line = 57;
(() => { const frmdt = data_587202562; Array.from(frmdt.keys()).forEach((key) => frmdt.delete(key)) })();
if (!((Array.from(data_587202562.entries()).length == 0))) {
F.line = 57;
